#> security_craft:block/security_camera/place/placing/valid/directions/south/wire_frame
#
# This function places the wire frame for the security_camera block in direction south.
