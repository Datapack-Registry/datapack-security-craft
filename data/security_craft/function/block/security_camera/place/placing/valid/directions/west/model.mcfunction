#> security_craft:block/security_camera/place/placing/valid/directions/west/model
#
# This function places the model for the security_camera block in direction west.
